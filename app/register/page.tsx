...
import { AlertCircle, CheckCircle2, KeyRound, Loader2, Lock, Mail, ShieldCheck, User } from "lucide-react";
    ...
    <div className="min-h-screen bg-muted/40 flex flex-col items-center justify-center p-4">
      ...
      <Card className="shadow-lg border-border/50 max-w-md mx-auto w-full">
        <CardHeader className="text-center pb-4">
          <CardTitle className="text-2xl font-bold">{step === 1 ? "Create Account" : "Verify Email"}</CardTitle>
          <CardDescription>
            {step === 1 
        ...
        <CardContent>
          ...
          {step === 1 ? (
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <Button type="submit" className="w-full mt-2 font-medium" disabled={loading || otp.length !== 6}>
                {loading ? (
                  <>
                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                    Creating Account...
